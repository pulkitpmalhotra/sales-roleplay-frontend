              ...
              {scenarios.length === 0 ? (
                ...
                <div className="scenarios-grid">
                  {scenarios.map((scenario) => (
                    <div key={scenario.scenario_id || scenario.id} className="scenario-card google-ads">
                      ...
                      <button
                        onClick={() => startRoleplay(scenario.scenario_id || scenario.id)}
